...
// GET: "/patients"
const ListPatients = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const search = (req.query.search || "");
    try {
        const query = { username: { $regex: search, $options: 'i' }, role: "Patient" };
